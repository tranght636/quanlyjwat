			...
			<div class="col-md-2">
				<ul class="list-group">
					<li
						...
						<div>
							<a href="/ui/themthongbao" style="color: black;">THÔNG BÁO</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="/ui/danhsachtaikhoan" style="color: black;">DANH SÁCH THÀNH VIÊN</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="/ui/xemthongtindangkylich" style="color: black;">XEM THÔNG TIN ĐĂNG KÝ LỊCH</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="#" style="color: black;">THÊM TÀI KHOẢN MỚI</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="/ui/taikhoanchoduyet" style="color: black;">TÀI KHOẢN CHỜ DUYỆT</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="#" style="color: black;">ĐIỂM DANH</a>
						</div>
					</li>
					<li
						class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
						<div>
							<a href="#" style="color: black;">THỐNG KÊ</a>
						</div>
					</li>
				</ul>
					...
					<li
						...
						<div>
							<img src='<c:url value="/resources/image/img3.png"/>' alt="icon"
								class="image" /> <a href="#">Thông báo 1</a>
						</div>

						<div>

							<img src='<c:url value="/resources/image/img2.png"/>' alt="icon"
								class="image" /> <img
								src='<c:url value="/resources/image/imgdelete.png"/>' alt="icon"
								class="image" /> <span class="badge badge-light">14 views</span>
